...
namespace Assignment_10_Entity_Framework_DML.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27015D5A1A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B45211CD15");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB856E6A9E48");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229C14BCD5D");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4FB5F4D28");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5A1488305");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C99C65325");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616491EF3C2B").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3718F50E3");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CFC8AD412");
